...
func pushGitOpsDirAndOpenPr(promotionName, destinationDir, printName string, cmd *cobra.Command) error {
	...
	return createGitHubPr(remote, cmd)
}
...
func stageChangedFiles(worktree *git.Worktree, appFolderName string) (detectedFileChanges, containsNewFiles bool, err error) {
...
func getGitRepoAndWorktree(basePath string) (repo *git.Repository, worktree *git.Worktree, err error) {
...
func createGitHubPr(remote *git.Remote, cmd *cobra.Command) error {
	...
	fmt.Printf("created GitHub PR with the base overlay from exported GitOps dir: %s\n", pr.GetHTMLURL())
	return nil
}
...
func newGitHubClient(ctx context.Context) (*github.Client, error) {
	...
	// FIXME: this should just inform how to open PR manually and that is it
